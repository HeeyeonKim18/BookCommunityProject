					...
					<div class="row">
						<div class="col-xl-12 col-lg-10">
							<div class="card shadow mb-4">
								...
								<!-- Card Body -->
								<div class="card-body">
									<form class="boardForm" method="post" action="/admin/memberModify">
										...
										<div class="form-group row">
											...
											<div class="col-sm-6 mb-3 mb-sm-0">
												...
												<select name="auth" class="form-control">
													<option value="1"
													<c:out value="${list.auth eq '1'? 'selected':''}"/>>관리자 전환</option>
													<option value="0"
													<c:out value="${list.auth eq '0'? 'selected':''}"/>>일반 회원</option>
												</select>
											</div>
										</div>
...
<script>
	...
	$("#deleteBtn").on("click", function(){
		form.attr("action", "/admin/memberRemove");
		form.submit();
	});
