                ...
                <div class="container-fluid">
					 ...
					 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                           <h6 class="m-0 font-weight-bold text-primary" style="display:inline-block">댓글 관리</h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                    		<td> ${i}</td>
                                    		<td><a class="move" href="/board/lookup?bno=<c:out value='${list.bno}'/>"> <c:out value="${list.bno}"/></a></td>
                                    		<td><c:out value="${list.replyer}"/></td>
                                    		<td><c:out value="${list.reply}"/></td>
                                    		<td><fmt:formatDate pattern="yyyy-MM-dd" value= '${list.replyDate}'/></td>
                                    		<td id="deleteBtn"><a class="btn btn-sm" href="<c:out value='${list.rno}'/>" >Delete</a></td>
                                    	</tr> 
                                    </c:forEach>
                                     </tbody>
                                 </table>
                                 <form id="actionForm" action="/admin/replyManagement" method="get">
